...
const images = [
    ...
    {src: 'images/kidAID.jpg', desc: 'Ballers Africa that focuses on promoting and developing various sports across the continent, Our aim is to provide world-class training, mentorship, and resources to aspiring athletes and coaches, as well as organize and support various sports events and leagues that showcase African talent and potential.', title: 'kidAID'}
];
